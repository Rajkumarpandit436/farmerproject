 ...
 * @author PANDIT
 */
public class deleteSoildetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean f=dao.deleteSoilDetails(deleteId);
            
            HttpSession session=request.getSession();
            if(f){
                //out.println("yes");
                session.setAttribute("deleteSuccess", "soil details deleted successfully");
                response.sendRedirect("admin/viewSoilDetails.jsp");
            }else{
                //out.println("no");
                session.setAttribute("deletError", "something happend wrong in server");
                response.sendRedirect("admin/viewSoilDetails.jsp");
            }
        }
    }
