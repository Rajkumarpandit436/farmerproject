...
<html lang="en">
    ...
    <body>
        ...
        <div class="tab-content" id="v-pills-tabContent">
            <div class="text-center mt-2 bg-light"><h2><b>Loam Soil</b></h2></div>

            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <%
                    SoilDetailsDao dao = new SoilDetailsDao(ConnectionProvider.getConnection());
                    List<SoilDetails> sd = dao.getLoamSoilDetails();
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <%
                                                ...
                                                List<CropInfo> sandycroplist = cdao.getDetailsByLoamSoil();
