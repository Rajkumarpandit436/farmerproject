<%-- 
    Document   : about_sandy_soil
    Created on : May 26, 2021, 1:16:02 PM
    Author     : PANDIT
--%>
...
<html>
    ...
    <body>
        ...
        <%
            ...
            List<SoilDetails> list = dao.getSandySoilDetails();

        %>



        <div class="sidenav nav flex-column nav-pills" role="tablist" aria-orientation="vertical" style="margin-top: 100px">
        ...
        <div class="tab-content mt-5 justify-content-end" id="v-pills-tabContent">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="row">
                                            ...
                                            <%
                                                ...
                                                List<CropInfo> sandycrop = cdao.getDetailsBySansySoil();
                                                for (CropInfo cp : sandycrop) {%>

                                            <div class="col-lg-4 mt-4 mt-lg-3">
                                                <div class="member">
                                                    <div class="image">
                                                        <img src="../cropTitleImage/<%=cp.getTitlepic()%>"  class="img-fluid" width="150px" height="100px" alt="img">
                                                    </div>
                                                    <div class="info">
